...
import (
	...
	clientrest "github.com/Fantom-foundation/cosmos-sdk/client/rest"
...
- [`BaseReq`](https://godoc.org/github.com/Fantom-foundation/cosmos-sdk/client/utils#BaseReq)包含用于进行交易的基本必填字段（使用哪个密钥，如何解码，使用哪条链等等）并且如所示被设计成嵌入形式。
